...
class BloodPressuresControllerTest < ActionController::TestCase
  ...
  test "should create blood_pressure" do
    assert_difference('BloodPressure.count') do
      post :create, blood_pressure: { diastolic: @blood_pressure.diastolic, dt: @blood_pressure.dt, patient_id: @blood_pressure.patient_id, systolic: @blood_pressure.systolic }
    end
  ...
  test "should update blood_pressure" do
    patch :update, id: @blood_pressure, blood_pressure: { diastolic: @blood_pressure.diastolic, dt: @blood_pressure.dt, patient_id: @blood_pressure.patient_id, systolic: @blood_pressure.systolic }
    assert_redirected_to blood_pressure_path(assigns(:blood_pressure))
  end
