...
class TemperaturesControllerTest < ActionController::TestCase
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post :create, temperature: { dt: @temperature.dt, patient_id: @temperature.patient_id, temperature: @temperature.temperature }
    end
  ...
  test "should update temperature" do
    patch :update, id: @temperature, temperature: { dt: @temperature.dt, patient_id: @temperature.patient_id, temperature: @temperature.temperature }
    assert_redirected_to temperature_path(assigns(:temperature))
  end
